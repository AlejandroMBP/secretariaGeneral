...
const EditAutoridad: React.FC<EditModalProps> = ({ isOpen, onClose, onSave, data, errors }) => {
    ...
    useEffect(() => {
        if (data) {
            setFormData({
                ...
                tipo_posicion: data.tipo_posicion ?? '',
