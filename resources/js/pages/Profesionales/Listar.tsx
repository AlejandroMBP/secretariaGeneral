...
export default function Listar() {
    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Profesionales', href: '/Profesionales' }]}>
            <Head title="Profesionales" />
            <div className="flex flex-col gap-6 p-6">
                <div className="dark:bg-sidebar rounded-xl bg-white p-6 shadow-md">
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Profesionales</h1>
                    <p className="mt-2 text-gray-600 dark:text-gray-300">
                        Aquí puedes gestionar y consultar los documentos relacionados con los profesionales.
                    </p>
                </div>
                <div className="dark:bg-sidebar rounded-lg bg-white p-6 shadow-md dark:text-white">
                    ...
                    <TableComponent headers={academicosHeaders} data={documentos} apiEndpoint="/diplomas-update" tipoDocumento="profesionales" />
                </div>
            </div>
        </AppLayout>
    );
