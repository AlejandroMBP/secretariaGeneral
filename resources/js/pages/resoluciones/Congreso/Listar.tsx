...
export default function Listar() {
    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Congreso', href: '/congreso' }]}>
            <Head title="Congreso" />
            <div className="flex flex-col gap-6 p-6">
                <div className="dark:bg-sidebar rounded-xl bg-white p-6 shadow-md">
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Resoluciones de congreso</h1>
                    <p className="mt-2 text-gray-600 dark:text-gray-300">
                        Aquí puedes gestionar y consultar los documentos relacionados con las resoluciones de congreso.
                    </p>
                </div>
